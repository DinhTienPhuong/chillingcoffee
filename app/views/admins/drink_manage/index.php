                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr class="">
                      ...
                      @endif
                      <td class="py-1"> {{ currency_format($value['donGia']) }} </td>
    ...
    <div class="pages">
      <div class="template-demo" style="width: fit-content;margin: 0 auto;">
        <div class="btn-group" role="group" aria-label="Basic example">
          @if($current_page > 1)
            <li style="list-style-type: none; padding: 0 2%;"> <a  class="btn btn-primary" href="{{_WEB_ROOT.'/drink-manage-trang-'.($current_page - 1 )}}"> < </a> </li>
          @endif

          @for($i = 1 ; $i <= $pageTotal ; $i++)
          <li style="list-style-type: none; padding: 0 2%;" class="{{ ($current_page == $i) ? 'active' : ''}}">
            <a  class="btn btn-primary" href="{{_WEB_ROOT.'/drink-manage-trang-'.$i}}"> {{$i}} </a> 
          </li>
          @endfor
