            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{_WEB_ROOT}}/paymentmethods/save" enctype="multipart/form-data">
                            
                            <div class="form-group">
                                <label for="payment_name">Tên Phương Thức Thanh Toán</label>
                                <input name="payment_name" type="text" class="form-control" id="payment_name" value="{!old('payment_name')!}">
                            ...
                            <div class="form-group">
                                ...
                                <input name="payment_description" type="text" class="form-control" value="{!old('payment_description')!}" id="payment_description">
                                <span class="form-message"> {!form_error('payment_description')!}</span>
                            </div>
                            <button type="submit" class="btn btn-primary mr-2">Thêm phương thức</button>
                        </form>
